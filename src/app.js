...
const background = new Sprite({
  ...
  imageSrc: './assets/battleArena.png',
});
...
const enemy = new Fighter({
  ...
  imageSrc: './assets/ninja/Idle.png',
  framesMax: 4,
  scale: 3,
  offset: {
    x: 215,
  ...
  sprites: {
    ...
    run: {
      imageSrc: './assets/ninja/Run.png',
      framesMax: 8,
    },
    jump: {
      imageSrc: './assets/ninja/Jump.png',
      framesMax: 2,
    },
    fall: {
      imageSrc: './assets/ninja/Fall.png',
      framesMax: 2,
    },
    attack1: {
      imageSrc: './assets/ninja/Attack1.png',
      framesMax: 4,
    },
    takeHit: {
      imageSrc: './assets/ninja/Take hit.png',
      framesMax: 3,
    },
    death: {
      imageSrc: './assets/ninja/Death.png',
      framesMax: 7,
    },
  },
  attackBox: {
